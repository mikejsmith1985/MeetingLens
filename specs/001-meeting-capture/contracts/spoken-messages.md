...
| `HANDOFF_OPEN` | after browser opens | "Your browser is open with Copilot. Press Tab to reach the chat box, then press Control V to paste your prompt. Then attach your screenshots from the folder that just opened." |
...
| `QUIT` | quit hotkey (FR-028) | "MeetingLens is closing. Goodbye." |
